...
<head>
    ...
    <link rel="stylesheet" href="../../styles/program_head-dashboard.css">
    ...
    <div class="container">
        ...
        <div class="center">
            ...
            <div class="center-con con3">
                ...
                <div style="display:flex;justify-content:space-between;align-items:center"><p>DEPARTMENTS</p> 
                <select name="" id="">
            ...
            <div class="reportcard">
               <div class="report-card">
                ...
                <div class="report-card">
                    <p>BSCRIM</p>
                    <img src="../../assets/images/bscrimlogo.png" alt="">
                    <code id="student">ENROLLED</code>
                    <code>98</code>
                </div>
